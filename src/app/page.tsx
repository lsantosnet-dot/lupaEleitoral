...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col gap-6 p-4">
      {/* Hero Section */}
      <section className="relative overflow-hidden rounded-3xl bg-slate-900 p-6 shadow-2xl shadow-indigo-950/20 border border-slate-800/50">
        ...
        <div className="relative z-10 flex flex-col gap-3 max-w-[90%]">
          ...
          <div className="flex gap-3 pt-1">
            <Button size="sm" className="bg-white text-slate-900 hover:bg-slate-100 rounded-xl h-9 px-5 font-bold shadow-md transition-all active:scale-95" asChild>
              <Link href="/explorar">Começar agora</Link>
            </Button>
            <Button variant="outline" size="sm" className="bg-transparent border-slate-700 text-slate-300 hover:bg-slate-800 hover:text-white rounded-xl h-9 px-5 font-bold transition-all active:scale-95" asChild>
